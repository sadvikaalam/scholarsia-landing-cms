...
const servicesData: ServiceData[] = [
  {
    ...
    title: "IT Solution",
    description:
      "Kami menghadirkan solusi IT terintegrasi, termasuk pengembangan perangkat lunak, pengelolaan data, optimalisasi jaringan, dan pengadaan perangkat keras inovatif. Solusi kami dirancang untuk meningkatkan efisiensi dan mendorong inovasi, membantu bisnis Anda tumbuh di era digital.",
  },
  {
    icon: IconBrowser,
    title: "Learning Management System",
    description:
      "Kami menawarkan platform pembelajaran digital yang dirancang untuk mengelola, menyampaikan, dan melacak proses belajar secara efisien. Solusi LMS kami mendukung pengembangan pendidikan berbasis teknologi modern.",
  },
  {
    icon: IconServer,
    title: "IT Management",
    description:
      "Kami menyediakan layanan manajemen TI yang terintegrasi untuk mengelola infrastruktur, aplikasi, dan sumber daya teknologi dengan cara yang lebih efisien. Pendekatan proaktif kami fokus pada peningkatan kinerja sistem, penguatan keamanan data, serta opti﻿masi proses operasional, membantu organisasi mencapai efisiensi maksimal dalam pemanfaatan teknologi.",
  },
  {
    icon: IconLicense,
    title: "Licensing",
    description:
      "Kami menyediakan layanan pengadaan lisensi resmi dari berbagai principal terkemuka, termasuk Microsoft. Solusi ini memastikan anda menggunakan software yang resmi, aman, dan mendukung produktivitas sekaligus kepatuhan terhadap regulasi.",
  },
];
...
const studentDevelopmentServices: ServiceData[] = [
  ...
  },
  {
    ...
    title: "Santri IT",
    description:
      "Santri IT adalah program pengembangan keterampilan bagi para santri di lingkungan pesantren yang bertujuan untuk membekali mereka dengan kemampuan teknologi dan soft skill yang relevan dengan kebutuhan dunia modern. Program ini dirancang untuk mengintegrasikan nilai-nilai pesantren dengan Teknologi",
  },
];
...
const developmentPrograms = [
  ...
  },
  {
    ...
    description:
      "Program Capacity Building Scolarsia berfokus pada  pada﻿ pemberdayaan generasi muda melalui pengembangan keterampilan berbasis IT yang mempersiapkan mereka menghadapi tantangan era digital. Program kami mencakup pelatihan teknologi, kepemimpinan digital, dan kewirausahaan berbasis inovasi, dengan pendekatan terintegrasi yang memastikan siswa dan mahasiswa siap berkompetisi secara global.",
  ...
  },
  {
    ...
    description:
      "Scolarsia Development Student Program adalah inisiatif komprehensif yang dirancang untuk memberdayakan siswa dengan keterampilan, pengetahuan, dan pengalaman yang esensial guna mencapai kesuksesan di bidang akademik maupun profesional.",
  ...
  return (
    ...
    <>
      ...
      >
        ...
        >
          Scolarsia Development Center adalah pusat unggulan yang
          mengintegrasikan pengembangan keterampilan dengan inovasi pendidikan
          global. Kami menghadirkan program pelatihan komprehensif berbasis
          teknologi untuk memberdayakan pelajar dan profesional Indonesia,
          membekali mereka dengan keahlian relevan agar siap bersaing di kancah
          internasional. Melalui pendekatan kolaboratif, kami mendukung
